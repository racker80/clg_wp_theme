...
add_action("wp_ajax_add_child_page", "add_child_page");
add_action("wp_ajax_nopriv_add_child_page", "add_child_page");

function add_child_page(){
	if ( !wp_verify_nonce( $_REQUEST['nonce'], "add_child_page")) {
...
function delete_page(){
	if ( !wp_verify_nonce( $_REQUEST['nonce'], "delete_page")) {
		exit("No naughty business please");
	}
